<?php
App::uses('ProductProductionsController', 'Controller');

/**
 * ProductProductionsController Test Case
 *
 */
class ProductProductionsControllerTest extends ControllerTestCase {
