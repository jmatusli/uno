<?php
App::uses('HoseMeasurement', 'Model');

/**
 * HoseMeasurement Test Case
 *
 */
class HoseMeasurementTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->HoseMeasurement = ClassRegistry::init('HoseMeasurement');
	}
