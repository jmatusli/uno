  ...
  echo '<div class="container-fluid">';
    echo '<div class="rows">';
      echo '<div class="col-sm-8">';
        ...
        if ($enterpriseId == 0){
          echo '<h2>Seleccione una gasolinera para registrar una factura</h2>';
        } 
        else {
          ...
          echo $this->Form->input('payment_mode_id',['empty'=>[0=>'-- Seleccione Modo de Pago --']]);
          ...
          echo $this->Form->input('currency_id',['default'=>CURRENCY_CS,'empty'=>[0=>'-- Seleccione Moneda --']]);
          ...
          echo $this->Form->input('creating_user_id',['type'=>'hidden','default'=>$loggedUserId]);
