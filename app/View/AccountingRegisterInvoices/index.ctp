...
<?php 
	echo "<h2>".__('Accounting Register Invoices')."</h2>";
...
<?php
	...
	foreach ($accountingRegisterInvoices as $accountingRegisterInvoice){ 
		$pageRow=""		$pageRow=""		$pageRow.="<td>".$this->Html->link($accountingRegisterInvoice['AccountingRegister']['id'], array('controller' => 'accounting_registers', 'action' => 'view', $accountingRegisterInvoice['AccountingRegister']['id']))."</td>";
		$pageRow=""		$pageRow.="<td>".$this->Html->link($accountingRegisterInvoice['Invoice']['id'], array('controller' => 'invoices', 'action' => 'view', $accountingRegisterInvoice['Invoice']['id']))."</td>";
		$pageRow=""		$pageRow=""
			$excelBody.="<tr>".$pageRow."</tr>";

			$pageRow.="<td class='actions'>";
				$pageRow.=$this->Html->link(__('View'), array('action' => 'view', $accountingRegisterInvoice['AccountingRegisterInvoice']['id']));
				$pageRow.=$this->Html->link(__('Edit'), array('action' => 'edit', $accountingRegisterInvoice['AccountingRegisterInvoice']['id']));
				//$pageRow.=->postLink(__('Delete'), array('action' => 'delete', $accountingRegisterInvoice['AccountingRegisterInvoice']['id']), array(), __('Are you sure you want to delete # %s?', $accountingRegisterInvoice['AccountingRegisterInvoice']['id']));
			$pageRow.="</td>";
