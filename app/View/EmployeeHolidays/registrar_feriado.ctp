...
<script>
  ...
  $('body').on('submit','#EmployeeHolidayRegistrarFeriadoForm',function(e){	
...
<?php 
  echo "<div id='saving' style='min-height:180px;z-index:9998!important;position:relative;'>";
    echo "<div id='savingcontent'  style='z-index:9999;position:relative;'>";
      echo "<p id='savingspinner' style='font-weight:700;font-size:24px;text-align:center;z-index:100!important;position:relative;'>Guardando los días feriados ...</p>";
    echo "</div>";
  echo "</div>";
  
  echo $this->Form->create('EmployeeHoliday'); 
	echo "<fieldset id='mainform'>";
		echo "<legend>".__('Registrar Días Feriados')."</legend>";
