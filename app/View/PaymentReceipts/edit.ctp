...
<?php echo $this->Form->create('PaymentReceipt'); ?>
	<fieldset>
		<legend><?php echo __('Edit Payment Receipt'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PaymentReceipt.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('PaymentReceipt.id'))); ?></li>
