...
<?php 
  ...
  echo "<div id='mainform'>";
    ...
    echo "<fieldset>";
      echo "<legend>".__('Add Purchase')."</legend>";
      echo "<div class='container-fluid'>";
        echo "<div class='row'>";
          ...
          echo $this->Form->input('third_party_id',['label'=>__('Provider'),'default'=>PROVIDER_UNO]);
          echo $this->Form->input('enterprise_id',['label'=>'Empresa','empty'=>['0' =>'Seleccione Empresa'],'default'=>ENTERPRISE_LAS_PALMAS]);
        ...
        echo "<div class='col-sm-3' style='padding:0 5px 0 30px;'>";
          ...
          echo $this->Form->input('adjustment',['label'=>__('Ajuste'),'default'=>'0','between'=>'<span class="currencyrighttop">C$ </span>','type'=>'decimal','style'=>'width:40%;']);
          echo $this->Form->input('rent',['label'=>'Renta','default'=>'0','between'=>'<span class="currencyrighttop">C$ </span>','type'=>'decimal','style'=>'width:40%;']);
          ...
          echo "<table id='productsForPurchase'>";
            ...
            for ($i=0;$i<count($requestProducts);$i++){
              echo "<tr row='".$i."'>";
              echo "<td class='productid'>".$this->Form->input('Product.'.$i.'.product_id',['label'=>false,'default'=>'0','empty' =>[0=>__('Choose a Product')],'value'=>$requestProducts[$i]['Product']['product_id'],'style'=>'font-size:90%'])."</td>";
              echo "<td class='productquantity'>".$this->Form->input('Product.'.$i.'.product_quantity',['type'=>'decimal','value'=>$requestProducts[$i]['Product']['product_quantity'],'label'=>false,'class'=>'width100'])."</td>";
              echo "<td class='productunitprice'><span class='currency'></span>".$this->Form->input('Product.'.$i.'.product_unit_price',['label'=>false,'type'=>'decimal','value'=>$requestProducts[$i]['Product']['product_unit_price'],'class'=>'width100'])."</td>";
              echo "<td  class='producttotalprice'>".$this->Form->input('Product.'.$i.'.product_total_price',['type'=>'decimal','label'=>false,'value'=>$requestProducts[$i]['Product']['product_total_price'],'class'=>'width100','readonly'=>'readonly'])."</td>";
            ...
            for ($i=$counter;$i<30;$i++){
              ...
              echo "<td  class='producttotalprice'>".$this->Form->input('Product.'.$i.'.product_total_price',['type'=>'decimal','label'=>false,'default'=>'0','class'=>'width100','readonly'=>'readonly'])."</td>";
              echo "<td><button class='removeMaterial'>".__('Remover')."</button></td>";
              echo "</tr>";
            }
