...
<?php echo $this->Form->create('ChequeType'); ?>
	<fieldset>
		<legend><?php echo __('Edit Cheque Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		<!--li><?php //echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ChequeType.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('ChequeType.id'))); ?></li-->
