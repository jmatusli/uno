...
<?php echo $this->Form->create('AccountingRegister'); ?>
	<fieldset>
		<legend><?php echo __('Edit Accounting Register'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AccountingRegister.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('AccountingRegister.id'))); ?></li>
