...
<?php 
	echo "<h2>".__('Accounting Register Cash Receipts')."</h2>";
...
<?php
	...
	foreach ($accountingRegisterCashReceipts as $accountingRegisterCashReceipt){ 
		$pageRow=""		$pageRow=""		$pageRow.="<td>".$this->Html->link($accountingRegisterCashReceipt['AccountingRegister']['id'], array('controller' => 'accounting_registers', 'action' => 'view', $accountingRegisterCashReceipt['AccountingRegister']['id']))."</td>";
		$pageRow=""		$pageRow.="<td>".$this->Html->link($accountingRegisterCashReceipt['CashReceipt']['id'], array('controller' => 'cash_receipts', 'action' => 'view', $accountingRegisterCashReceipt['CashReceipt']['id']))."</td>";
		$pageRow=""		$pageRow=""
			$excelBody.="<tr>".$pageRow."</tr>";

			$pageRow.="<td class='actions'>";
				$pageRow.=$this->Html->link(__('View'), array('action' => 'view', $accountingRegisterCashReceipt['AccountingRegisterCashReceipt']['id']));
				$pageRow.=$this->Html->link(__('Edit'), array('action' => 'edit', $accountingRegisterCashReceipt['AccountingRegisterCashReceipt']['id']));
				//$pageRow.=->postLink(__('Delete'), array('action' => 'delete', $accountingRegisterCashReceipt['AccountingRegisterCashReceipt']['id']), array(), __('Are you sure you want to delete # %s?', $accountingRegisterCashReceipt['AccountingRegisterCashReceipt']['id']));
			$pageRow.="</td>";
