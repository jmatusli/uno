    ...
    foreach ($shifts as $shiftId=>$shiftName){
      ...
      foreach ($saleShifts['Shift'][$shiftId]['Operators'] as $operatorId=>$operatorData){
        ...
        $operatorTotalRow="<tr class='totalrow green'>";
          $operatorTotalRow.="<td>Combustibles ".$shiftName." ".$operatorData['Operator']['name']."</td>";
      ...
      foreach ($islands as $island){
        ...
        foreach ($island['Hose'] as $hose){
          ...
          $hoseTableRow="<tr id=".$hose['id'].">";
            ...
            $hoseTableRow.="</td>";
            $hoseTableRow.="<td class='final centered'>".number_format($hose['HoseCounter'][0]['counter_value'],2,".",",")."</td>";
            $hoseTableRow.="<td class='initial centered'>".number_format($hose['HoseCounter'][0]['counter_value'],2,".",",")."</td>"; 
    ...
    $measurementTableRows="";
      ...
      if (!empty($tankMeasurements)){
        ...
        $differenceRow.="<tr class='totalrow deviations'>";
          ...
          foreach ($fuels as $fuel){
            $differenceRow.="<td class='centered deviation' fuelid=".$fuel['Product']['id'].">".number_format($fuel['Product']['final_existence']-$tankMeasurements[$fuel['Product']['id']],2,".",",")."</td>";
          }
          $differenceRow.="<td class='centered deviationTotal'>".number_format($totalFinalExistence-$totalMeasurements,2,".",",")."</td>";
        $differenceRow.="</tr>";
    ...
    echo "<div class='row'>";
      echo "<div class='col-sm-12'>";	
        echo "<div class='col-sm-6 col-lg-6'>";	
          ...
          echo "</fieldset>";  
          echo $this->Form->end();    
          echo $this->Html->link(__('Guardar como pdf'), ['action' => 'pdfInformeDiario','ext'=>'pdf', $saleDate,$namePdf],['class'=>'btn btn-primary','target'=>'_blank']);
        echo "</div>";
        echo "<div class='col-sm-6 col-lg-6 totals'>";
          $totalPriceSales=$totalPriceFuels + $totalPriceLubricants;
          
          echo "<h4>".__('Totales de Venta')."</h4>";			
          echo "<dl>";
            echo "<dt>Combustibles</dt>";
            echo "<dd>C$ ".$totalPriceFuels."</dd>";
            echo "<dt>Lubricantes</dt>";
      ...
      echo "<div class='col-sm-12'>";
        echo "<div class='col-sm-12 col-lg-6' style='padding:5px;'>";
          foreach ($shiftTables as $shiftTable){
            echo "<h3>".__('Combustibles')." ".$shiftTable['shift_name']."</h3>";
            echo $shiftTable['fuelTable'];
            echo $shiftTable['calibrationsTable'];
          }
        echo "</div>";   
        echo "<div class='col-sm-12 col-lg-6' style='padding:5px;'>";
        ...
        echo "<div class='col-sm-12 col-lg-6' style='padding:5px;'>";
          ...
          echo $shiftFuelTable;
        echo "</div>";   
        // 20191117 tank grafph data was removed because it is based on stockitemlogs, and therefore does not necessarily correspond with measurements
        //echo "<div class='col-sm-12 col-lg-6' style='padding:5px;'>";
