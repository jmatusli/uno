...
<?php 
	echo "<h2>".__('Accounting Register Types')."</h2>";
...
<?php
	...
	foreach ($accountingRegisterTypes as $accountingRegisterType){ 
		$pageRow=""		$pageRow=""		$pageRow.="<td>".h($accountingRegisterType['AccountingRegisterType']['abbreviation'])."</td>";
		$pageRow=""		$pageRow.="<td>".h($accountingRegisterType['AccountingRegisterType']['name'])."</td>";
		$pageRow=""		$pageRow.="<td>".h($accountingRegisterType['AccountingRegisterType']['description'])."</td>";
		$pageRow=""		$pageRow=""
			$excelBody.="<tr>".$pageRow."</tr>";

			$pageRow.="<td class='actions'>";
				$pageRow.=$this->Html->link(__('View'), array('action' => 'view', $accountingRegisterType['AccountingRegisterType']['id']));
				$pageRow.=$this->Html->link(__('Edit'), array('action' => 'edit', $accountingRegisterType['AccountingRegisterType']['id']));
				//$pageRow.=->postLink(__('Delete'), array('action' => 'delete', $accountingRegisterType['AccountingRegisterType']['id']), array(), __('Are you sure you want to delete # %s?', $accountingRegisterType['AccountingRegisterType']['id']));
			$pageRow.="</td>";
